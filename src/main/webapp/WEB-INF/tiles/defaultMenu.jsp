		...
		<div id="sidebar"
			...
			<ul class="nav nav-list">
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						...
						<sec:authorize access="hasRole('ADMIN')">
							<li class=""><a href="/DesignAdminReptPage"> <i
									class="menu-icon fa fa-caret-right"></i> Design Services Reports
							</a> <b class="arrow"></b></li>
						</sec:authorize>
						
						<sec:authorize access="hasRole('ADMIN')">
							<li class=""><a href="/DesignAdminDeptReptPage"> <i
									class="menu-icon fa fa-caret-right"></i> Design Department Reports
							</a> <b class="arrow"></b></li>
						</sec:authorize>
						...
						<sec:authorize access="hasRole('ADMIN') OR hasRole('SDEF')">
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
						class="menu-icon fa fa-pencil-square-o"></i> <span
						class="menu-text">Master Operations </span> <b
						class="arrow fa fa-angle-down"></b>
				</a> <b class="arrow"></b>
