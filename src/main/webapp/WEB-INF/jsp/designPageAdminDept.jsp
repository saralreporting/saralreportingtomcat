	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active"><a href="/DesignAdminDeptReptPage">Design Department Report</a></li>
			</ul>
			<!-- /.breadcrumb -->
		</div>
		...
		<div class="page-content">
			...
			<div class="row">
				 ...
				 <div id="hdndivval">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color: aliceblue; margin-bottom: 15px; padding: 0;">
							<div class="col-lg-6 col-md-6 col-xs-12" id="departmentNames" style="padding: 0;">
