						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Saral</span>
									<span class="white" id="id-text2">Reporting</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; NIC Haryana</h4>
							</div>
...
jQuery(function($) {
$( "#login" ).removeClass( "no-skin" ).addClass( "login-layout" );
});
</script>
		<!--[if !IE]> -->
