	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			...
			<div class="nav-search" id="nav-search">
				<label>Select Department</label> <select name="deptidwithName"
					id="deptidwithName">
					<c:forEach items="${deptidwithName}" var="category1">
						<option value="${category1.orgCode}">${category1.orgName}</option>
					</c:forEach>
				</select> <input type="button" id="buttonToRefreshOnChange"
					style="display: none;" class="btn no-border" value="Refresh"
					onclick="javascript:RefreshReportView()" />
			</div>
			<!-- /.nav-search -->
		</div>
		...
		<div class="page-content">
				...
				<div class="col-lg-12 col-md-12 col-xs-12">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="carousel slide" data-ride="carousel" data-type="multi"
							data-interval="false" id="myCarousel">
							<div class="carousel-inner">
								<div class="item active">
									<div class="col-md-2 col-sm-6 col-xs-4 cus-carimg">
										<a href="#"><img src="assets/images/slider/AreaChart.png"
								...
								<div class="item">
									<div class="col-md-2 col-sm-6 col-xs-4 cus-carimg">
										<a href="#"><img src="assets/images/slider/PieChart.png"
											class="pie img-responsive" alt="PieChart" data-toggle="modal"
											data-target="#exampleModal"></a>
									</div>
								</div>
								<div class="item">
									<div class="col-md-2 col-sm-6 col-xs-4 cus-carimg">
										<a href="#"><img src="assets/images/slider/StackedBar.png"
			...
			<div class="right-content">
				...
				<div id="reportHeader"
					style="margin-top: inherit; text-align: -webkit-center;"></div>
				<div class="cuschart">
					<div id="arechart"
					...
					<div class="hitable1 table-responsive"
						style="min-width: 310px; max-width: 1100px;">
						...
						<div id="exampleExport"
							style="margin-left: initial; width: 100%; border-style: solid; border-width: thin; padding-top: 2%; padding-bottom: 1%;">
						...
						<div id="exampleNoData"
							style="margin-left: initial; width: 100%; border-style: groove; border-width: thin; padding-top: 2%;">
							<label id="exampleNoDataMessage"></label> <a
								href="/fetchReportList" class="btn btn-default">Go Back</a>
						</div>

						<div id="ordrsa" class="row"
									...
									<div class="widget-body">
										<div class="widget-main no-padding">
											...
											<div class="form-group" style="padding-top: 4%;">
												...
												<a href="javascript:void(0);" onclick="refreshData()">Apply
													Filter</a> <input type="hidden" id="odrbyFromSession"
													name="odrbyFromSession" />
											</div>
										</div>
									</div>
								</div>
						...
						<div id="exampleSumReport" class="row"
							style="margin-left: initial; width: 100%; border-style: groove; border-width: thin; padding-top: 2%;">
							<div class="col-xs-12"
								style="padding-top: 0%; padding-bottom: 1%;">
								<div class="widget-box collapsed">
									<div class="widget-header widget-header-flat">
										<h4 class="widget-title lighter">
											<i class="ace-icon fa fa-star orange"></i> Aggregation Of
											Columns
										</h4>
									...
									<div class="widget-body" style="height: 8%;">
										<div class="widget-main no-padding">
											<div class="form-group">
												<label class="control-label col-sm-2" for="rpSumCondition">Aggregation
													for Columns :</label>
												...
												<div class="col-sm-3">
													<input type="text" name="sumvalue" value="0"
														disabled="disabled" id="sumvalue">
												</div>

												<div class="col-sm-1">
													<input type="button" style="" class="btn no-border"
														value="Aggregation" onclick="javascript:submitComment()" />
												</div>
											</div>
										</div>
									</div>
					...
					<div id="piechart2">
						<div class="col-sm-3" id="selcolforPieChart">
							<label>Select Column</label> <select name="colforPieChart"
								id="colforPieChart">
								<c:forEach items="${listCol}" var="category">
									<option value="${category.reportSelectedColumnId}">${category.reportSelectedColumnName}</option>
								</c:forEach>
							</select><br /> <a href="javascript:void(0);"
		        ...
		        var table = $('#example').DataTable({
			        ...
			        rowGroup: {
			        	  ...
			        	  startRender: function ( rows, group ) {
			        		 // console.log(rows.versionNo);
			        		console.log(rows.data());
			                  return group +' count ('+rows.count()+')';
			              },
			              dataSrc: ${groupValues}
