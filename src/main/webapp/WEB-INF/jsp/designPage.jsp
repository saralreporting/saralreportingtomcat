	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active"><a href="/DesignReptPage">Design Page</a></li>
			</ul>
			<!-- /.breadcrumb -->
		...
		<div class="page-content">
			...
			<!-- /.page-header -->
			<div class="col-lg-12 col-md-12 col-xs-12" id="reprt2" style="background-color: aliceblue; margin-bottom: 15px;">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-2 cus-input-ext">
						...
						<div class="tabbable">
							<ul class="nav nav-tabs">
								...
								<li id="c2"><a href="#customize" data-toggle="tab" onclick="javascript:changeTab()"><img
										src="../assets/images/reports1.png"
								...
								<li id="c3"><a href="#divForOrdr" data-toggle="tab" onclick="javascript:changeTab2()"><img
										src="../assets/images/orderby2.png"
								...
								<li id="c4"><a href="#divForWhere" data-toggle="tab" onclick="javascript:changeTab3()"><img
										src="../assets/images/wherecond.png"
								...
								<li id="c5"><a href="#divForHaving" data-toggle="tab" onclick="javascript:changeTab4()"><img
										src="../assets/images/havingcond.png"
							...
							<div class="tab-content cus-tabs">
									...
									<div class="col-lg-12 col-md-12 col-xs-12" id="selcol" style="display: none;">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 cus-list-div" id="collist">
											...
											<div class="container" id="ContentPlaceHolder1_CheckBoxList1"
												style="overflow: scroll; height: 300px; width: 100%; float: left; padding: 15px; BACKGROUND-COLOR: aliceblue;">
											</div>
										</div>
										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 cus-list-div" id="selcollist">
											<h5 class="cus-list-heading" align="left">Selected columns for report</h5>
											<div id="sortable1"
												style="overflow: scroll; height: 150px; width: 100%; float: left; padding: 15px; background-color: aliceblue;">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 text-center cus-upper-heading">
									...
									<input type="hidden" id="hddnJSONB" name="hddnJSONB" /> <input
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 cus-form-group">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 cus-labels-div">
										<label class="cus-labels" for="rpColor">
											Table Color:</label>
											</div>
										<div class="col-sm-8">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 cus-form-group">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 cus-labels-div">
										<label class="cus-labels" for="tooltip">
											Tool-tip:</label>
											</div>
											
										<div class="col-sm-8">
											<input type="text" class="form-control" id="tooltip"
												placeholder="Enter Tool-tip" name="tooltip" required="required">
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 cus-form-group">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 cus-labels-div">
										<label class="cus-labels" for="rpGrpBy">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cus-form-group">
										...
										<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12 cus-text-input">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cus-form-group">
									<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 cus-labels-div">
										<label class="cus-labels" for="rpFooter">
								...
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 cus-labels-div">
										<label class="cus-labels" for="rpWhrCondition">Having Condition :</label>
											...
											<div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 cus-input-bttns" style="padding: 0;">
									...
									<h4>Report Details - Aggregation</h4> 
										...
										<div class="form-group">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center cus-input-bttns">
												<input type="submit" class="btn btn-purple no-border" value="Save Report Design"
